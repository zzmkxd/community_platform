...
CREATE TABLE IF NOT EXISTS `message` (
    ...
    `extra`       TEXT         DEFAULT NULL COMMENT '扩展信息 JSON (MySQL 5.6兼容)',
...
CREATE TABLE IF NOT EXISTS `secure_invoke_record` (
    ...
    `secure_invoke_json` TEXT        NOT NULL COMMENT '方法调用快照 (className+methodName+parameterTypes+args)',
