...
public class MessageController {
    ...
    @Operation(summary = "发送消息（支持文本、回复、话题内发送、携带文件）")
    @PostMapping
    ...
    @Operation(summary = "获取频道消息列表（游标分页，可按话题过滤）")
    @GetMapping
    ...
    @Operation(summary = "编辑消息内容（仅限消息作者）")
    @PutMapping("/{msgId}")
    ...
    @Operation(summary = "删除消息（仅限消息作者或管理员）")
    @DeleteMapping("/{msgId}")
